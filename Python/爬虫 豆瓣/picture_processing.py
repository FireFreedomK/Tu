...
def split_fig(self):
    ...
    img_new.show()
    img_new.save("picture\\split_fig.jpg")
...
if __name__ == '__main__':
    img = Image.open("picture\\picture_3.jpg")
    pre_concert(img)

    remove_noise(img, 2)
    #self=Image.open("picture\\mov_noise_fig.jpg")
    ...
    img1=Image.open('picture\\mov_noise_fig.jpg')
    result=image_to_string(img1)
    print(result)
    time.sleep(10)
    # main()